...
class DocumentationIntegrationTest extends AbstractIntegrationTest {

  @Test
  void openApiDocumentContainsApplicationMetadataAndMainApis() throws Exception {
    mockMvc
        ...
        .andExpect(jsonPath("$.paths['/api/borrowings']").exists());
  }
}
