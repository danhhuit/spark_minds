...
public class MailService {
  ...
  public void sendVerificationEmail(String recipient, String rawToken) {
    String verificationUrl = frontendUrl + "/?token=" + rawToken;

    SimpleMailMessage message = new SimpleMailMessage();

    message.setFrom(mailFrom);
    message.setTo(recipient);
    message.setSubject("Verify your library account");
    message.setText(
        "Welcome to Library Management!\n\n"
            ...
            + timeToLiveProperties.emailVerificationSeconds()
            + " seconds.");
  ...
  public void sendPasswordResetEmail(String recipient, String rawToken) {
    String resetUrl = frontendUrl + "/?resetToken=" + rawToken;

    SimpleMailMessage message = new SimpleMailMessage();

    message.setFrom(mailFrom);
    message.setTo(recipient);
    message.setSubject("Đặt lại mật khẩu Spark Library");
    message.setText(
        "Hệ thống vừa nhận được yêu cầu đặt lại "
            ...
            + timeToLiveProperties.passwordResetSeconds()
            + " giây.\n"
  ...
  public void sendEmailChangeCode(String newEmail, String verificationCode) {
    SimpleMailMessage message = new SimpleMailMessage();

    message.setFrom(mailFrom);
    message.setTo(newEmail);
    message.setSubject("Verify your new library email");
    message.setText(
        "You requested to change your "
            ...
            + timeToLiveProperties.emailChangeVerificationSeconds()
            + " seconds."
