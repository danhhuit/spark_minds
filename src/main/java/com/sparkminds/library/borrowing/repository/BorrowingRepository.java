...
public interface BorrowingRepository extends JpaRepository<Borrowing, Long> {
  ...
  boolean existsByMember_IdAndStatus(Long memberId, BorrowingStatus status);
  ...
  @EntityGraph(attributePaths = {"member", "member.user", "book"})
  Page<Borrowing> findByMember_User_Id(Long userId, Pageable pageable);

  @EntityGraph(attributePaths = {"member", "member.user", "book"})
  @Query("select borrowing from Borrowing borrowing")
  Page<Borrowing> findAllDetailed(Pageable pageable);
}
