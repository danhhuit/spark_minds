...
public record UpdateBookRequest(
    @NotBlank(message = "ISBN is required") @Size(max = 20, message = "ISBN is too long")
        String isbn,
    @NotBlank(message = "Title is required") @Size(max = 255, message = "Title is too long")
        String title,
    ...
    @NotEmpty(message = "At least one author is required")
        Set<
                ...
                @Size(max = 150, message = "Author name is too long") String>
            authorNames) {}
