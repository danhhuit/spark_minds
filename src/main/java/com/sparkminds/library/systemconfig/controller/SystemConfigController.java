...
public class SystemConfigController {
  ...
  public ResponseEntity<SystemConfigResponse> updateMaintenanceMode(
      @AuthenticationPrincipal Jwt jwt, @Valid @RequestBody MaintenanceUpdateRequest request) {
    return ResponseEntity.ok(systemConfigService.updateMaintenanceMode(jwt, request));
  }
}
