...
public class PasswordService {
  ...
  public MessageResponse requestPasswordReset(String email) {
    ...
    userAccountRepository
        ...
        .ifPresent(
            user -> {
              ...
              resetTokenRepository.markUnusedTokensAsUsed(user.getId(), now);
              ...
              token.setExpiresAt(now.plus(timeToLiveProperties.passwordReset()));
    ...
    return new MessageResponse("If the email exists, " + "a password reset email was sent.");
  }
  ...
  public MessageResponse resetPassword(ResetPasswordRequest request) {
    PasswordResetToken resetToken =
        resetTokenRepository
            .findByTokenHashAndUsedFalse(hash(request.token()))
    ...
    return new MessageResponse("Password reset successfully. " + "Please login again.");
  }
  ...
  public MessageResponse changePassword(Jwt jwt, ChangePasswordRequest request) {
    ...
    UserAccount user =
        userAccountRepository.findById(userId).orElseThrow(CurrentPasswordMismatchException::new);
    ...
    refreshTokenRepository.revokeAllActiveTokens(userId, now);
