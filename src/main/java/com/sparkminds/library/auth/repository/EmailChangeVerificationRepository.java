...
public interface EmailChangeVerificationRepository
  ...
  Optional<EmailChangeVerification> findTopByUser_IdAndUsedFalseOrderByCreatedAtDesc(Long userId);
  ...
  @Query(
      """
        ...
        """)
  int invalidateUnusedCodes(@Param("userId") Long userId, @Param("usedAt") OffsetDateTime usedAt);
}
