...
public class AuthController {
  ...
  public ResponseEntity<MessageResponse> forgotPassword(
    ...
    return ResponseEntity.ok(passwordService.requestPasswordReset(request.email()));
  }
  ...
  public ResponseEntity<MessageResponse> changePassword(
    ...
    return ResponseEntity.ok(passwordService.changePassword(jwt, request));
  }
  ...
  public ResponseEntity<TokenResponse> exchangeSocialLoginCode(
    ...
    return ResponseEntity.ok(socialLoginCodeService.exchange(request.code()));
  }
  ...
  public ResponseEntity<MessageResponse> requestEmailChange(
    ...
    return ResponseEntity.ok(emailChangeService.requestEmailChange(jwt, request));
  }
  ...
  public ResponseEntity<MessageResponse> verifyEmailChange(
      @AuthenticationPrincipal Jwt jwt, @Valid @RequestBody VerifyEmailChangeRequest request) {
    return ResponseEntity.ok(emailChangeService.verifyEmailChange(jwt, request));
  }
  ...
  public ResponseEntity<CurrentUserResponse> me(@AuthenticationPrincipal Jwt jwt) {
    return ResponseEntity.ok(CurrentUserResponse.from(jwt));
  }
}
