...
public class GlobalExceptionHandler {
  ...
  @ExceptionHandler({CurrentPasswordMismatchException.class, PasswordReuseException.class})
  ...
  public ResponseEntity<ApiErrorResponse> handleInvalidEmailChange(
      InvalidEmailChangeException exception, HttpServletRequest request) {
    return build(HttpStatus.BAD_REQUEST, exception.getMessage(), request, Map.of());
  }
  ...
  public ResponseEntity<ApiErrorResponse> handleInvalidSocialLoginCode(
      InvalidSocialLoginCodeException exception, HttpServletRequest request) {
    return build(HttpStatus.UNAUTHORIZED, exception.getMessage(), request, Map.of());
  }
    ...
    exception
        ...
        .forEach(
            violation -> {
              ...
              String fieldName =
                  separatorIndex >= 0 ? propertyPath.substring(separatorIndex + 1) : propertyPath;
  ...
  public ResponseEntity<ApiErrorResponse> handleCsvImport(
      CsvImportException exception, HttpServletRequest request) {
    return build(HttpStatus.BAD_REQUEST, exception.getMessage(), request, Map.of());
  }
  ...
  public ResponseEntity<ApiErrorResponse> handleFileTooLarge(
    ...
    return build(HttpStatus.PAYLOAD_TOO_LARGE, "File size must not exceed 5 MB", request, Map.of());
  }
