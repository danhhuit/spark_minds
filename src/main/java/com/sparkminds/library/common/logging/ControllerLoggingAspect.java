...
public class ControllerLoggingAspect {
  ...
  public Object logControllerMethod(ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    String arguments = summarizeArguments(joinPoint.getArgs(), requestUri);
  ...
  private String summarizeArguments(Object[] arguments, String requestUri) {
  ...
  private String summarizeArgument(Object argument) {
     ...
     */
    return argument.getClass().getSimpleName() + "{fields=masked}";
  }
  ...
  private String summarizeResult(Object result) {
    ...
    return result.getClass().getSimpleName() + "{fields=masked}";
  }
}
